    ...
    <nav class="fixed top-10 z-80 w-full bg-white border-gray-200 dark:bg-gray-900">
        <div class="flex justify-between items-center mx-auto max-w-screen-xl px-4 py-2">
            ...
            <div class="flex items-center space-x-6 rtl:space-x-reverse">
                ...
                <a class="text-sm text-blue-500 dark:text-blue-500 hover:underline">
                    <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="text-sm pr-2 text-blue-600 dark:text-blue-500 type=">
                        Login
                    </button>
                </a>
            </div>
