...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $ct_email = $_GET['ct_email'];

    $selectQuery = "SELECT * FROM customer WHERE ct_email = '$ct_email'";
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span class="ms-1 text-sm font-medium md:ms-2 text-gray-400">Customer
                                        Details</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <h1 class="text-4xl font-bold mb-4">Customer Details</h1>
                    ...
                    <div class="bg-gray-800 shadow-md rounded-lg flex flex-col mb-6">
                        ...
                        <div class="flex flex-row px-6 py-6">
                            <div class="flex-none flex flex-col items-center mr-4 ">
                                <img src="<?php echo $ct_img; ?>" alt="Profile Photo 1" class="w-40 h-40 rounded-full mb-2">
                            </div>
