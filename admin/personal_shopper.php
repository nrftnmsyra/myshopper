...
<body class="bg-gray-100">
    <div class="p-4 sm:ml-52 h-100">
        ...
        <div class="relative overflow-x-auto shadow-md  mt-20">
            <h1 class="text-4xl font-bold mb-4">Personal Shopper</h1>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                <a href="personal_shopper_details.php" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit user</a>
                            </td>
                        </tr>
