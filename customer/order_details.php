        ...
        if ($resultQ->num_rows > 0) {
            ...
            <div class="rounded-lg p-4">
                ...
                <div class="mt-1 mb-2.5 flex justify-start item-start space-y-2 flex-col">
                    <h1 class="text-xl text-black lg:text-4xl font-bold leading-7 lg:leading-9">Order #
                        <?php echo $rowQ['iv_id']; ?>
                    </h1>
                    <p class="text-base text-gray-800 font-medium leading-6">
                        <?php echo date_format($date, "jS F Y") ?> at
                        <?php echo date_format($time, "g:i A"); ?>
                    </p>
                </div>

                <div class="w-full border rounded-lg shadow bg-gray-800 border-gray-900 px-6 py-4">
                    <?php include 'order_tracking.php'; ?>
                </div>
                <h1 class="text-2xl font-bold mb-2.5 mt-10">Order Details</h1>
                <div
                    class="mb-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
                    <div class="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                        <div
                            class="rounded-lg p-4 flex flex-col justify-start items-start bg-gray-800 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                    ...
                    o.order_code = '$order_code'";
                                ...
                                while ($row2 = mysqli_fetch_assoc($result2)) {
                                    ...
                                    <div
                                        ...
                                        <div class="h-28 w-28">
                                            ...
                                            <img class="h-full w-full object-cover rounded-lg" src="<?php echo $row2['pd_img']; ?>"
                                                alt="" />
                                        </div>
                                        <div class="flex items-center w-2/5"> <!-- Updated this div -->
                        ...
                        <div
                            ...
                            <div class="rounded-lg flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-800 space-y-6">
                            ...
                            <div
                                class="rounded-lg flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-800 space-y-6">
                    ...
                    <div
                        class="rounded-lg p-4 bg-gray-800 w-full xl:w-96 flex justify-between items-center md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col">
                        <h3 class="text-xl text-white font-semibold leading-5">Customer's Details</h3>
                        <div
                        ...
                        <div class="flex w-full justify-center items-center md:justify-start md:items-start">
                            <button onClick="parent.location='view_invoice.php?order_code=<?php echo $order_code; ?>'"
                                class="mt-6 md:mt-0 border-white hover:bg-gray-900 bg-transparent text-white py-5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border font-medium w-96 2xl:w-full text-base font-medium leading-4">View
                                Invoice</button>
                        </div>
                    </div>
                </div>
                ...
                if (($order_status == 'To Ship') || ($order_status == 'To Pay')) { ?>
                    <div class="mb-10 mt-5 flex w-full justify-center items-center md:justify-start md:items-start">
                        <button onclick="window.location.href ='order_cancel.php?order_code=<?php echo $order_code ?>'"
                            class="focus:outline-none text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-red-600 hover:bg-red-700 focus:ring-red-900">Cancel
                            Order</button>
                    </div>
                    <?php
                }
