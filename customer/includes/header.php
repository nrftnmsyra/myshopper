    ...
    <nav class="fixed top-10 z-80 w-full bg-white border-gray-200 dark:bg-gray-900">
        <div class="flex justify-between items-center mx-auto max-w-screen-xl px-4 py-2">
            ...
            <div class="pl-2 pr-16">
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Request +</button>
            </div>
            <div class="flex items-center space-x-6 rtl:space-x-reverse">
                ...
                <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="text-sm  text-blue-600 dark:text-blue-500 type="button">
                    Login
                </button>
            </div>
        </div>
...
const openModal = () => {
    ...
    // Additional actions to handle the modal open state
};
...
const closeModal = () => {
    ...
    // Additional actions to handle the modal close state
};
