            ...
            <div class="flex-1 py-2 pl-16">
                <form class="m-0" id="search" method="post" action="">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="search" id="searchInput" onkeyup="myFunction()"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="" method="post">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-700">Login
