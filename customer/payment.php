...
if (isset($_SESSION['email']) && isset($_SESSION['checkoutIds'])) {
  ...
  $query = "SELECT o.*, p.pd_name, p.pd_img, c.*, ct.*
            FROM orders o
      ...
      <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-10 mb-10">
        ...
        <p class="text-gray-400">Complete your order by providing your payment details.</p>
          ...
          <div class="flex items-center rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm focus-within:border-blue-500 focus-within:ring-blue-500">
            ...
            <input type="text" id="email" name="email" class="w-full outline-none focus:outline-none" placeholder="your.email@gmail.com" value="<?php echo $email; ?>"/>
          </div>
          ...
          <div class="flex items-center rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm focus-within:border-blue-500 focus-within:ring-blue-500">
            ...
            <input type="text" id="card-holder" name="card-holder" class="w-full outline-none focus:outline-none" placeholder="Your full name here" value="<?php echo $ct_first_name.' '.$ct_last_name; ?>"/>
          </div>
          ...
          <div class="flex items-center rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm focus-within:border-blue-500 focus-within:ring-blue-500">
              <input type="text" id="billing-address" name="billing-address" class="w-full outline-none focus:outline-none" placeholder="Street Address" value="<?php echo $ct_address; ?>"/>
          </div>
