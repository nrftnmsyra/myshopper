              ...
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                  ...
                  <div class="flex w-full flex-col px-4 py-4">
                    ...
                    <span class="float-right text-gray-400">Quantity :
    ...
    <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-10 mb-10">
      ...
      <div class="flex items-center">
        <input type="text" id="card-no" name="card-no"
          class="w-full rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm focus:z-0 focus:border-blue-500 focus:ring-blue-500"
