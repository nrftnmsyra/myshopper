    ...
    <div id="ordersContent" class="rounded-lg p-4">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                ?>
                <div class="mb-5 w-full border rounded-lg shadow bg-gray-800 border-gray-900 px-6 py-4 order-card"
                    data-order-status="<?php echo strtolower($order_status); ?>">

                    <a href="order_details.php?order_code=<?= $order_code ?>">
                        <div class="border-b border-gray-600">
                            <a href="ps_details.php?ps_email=<?php echo $ps_email; ?>" class="w-full flex items-center mb-2.5">
                                <img class="w-8 h-8 rounded-full" src="<?php echo $ps_img; ?>" alt="Jese image">
                                <h2
                                    class="text-2xl tracking-tight text-white font-bold p-3 flex items-center justify-between w-full">
                    ...
                    <div>
                        <label for="quantity" class="mb-2 font-normal text-gray-400">Quantity : x
            ...
            <div class="border-t border-gray-600 flex justify-between p-3">
                ...
                <div class="flex items-center ml-auto">
                    ...
                    <button type="submit"
                        class="p-5 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg focus:ring-4 focus:outline-none bg-blue-600 hover:bg-blue-700 focus:ring-blue-800"
