        ...
        if ($result->num_rows > 0) {
            ...
            foreach ($groupedProducts as $ps_email => $products) {
                ...
                <div class="mb-5 w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-900 px-6 py-4">
                    <div>
                        <h2 class="text-2xl tracking-tight text-gray-900 dark:text-white font-bold border-b border-gray-600 p-3"><?php echo $ps_username;?></h2>
                    </div>
                    ...
                    foreach ($products as $product) {
                        ...
                        <div class="flex items-center bg-white rounded-lg dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="p-5 w-full">
                                ...
                                <div>
                                    <label for="quantity" class="mb-2 font-normal text-gray-700 dark:text-gray-400">Quantity :</label>
                                    <!-- input number -->
            ...
            <div>
                <h2 class="text-xl tracking-tight text-gray-900 dark:text-white border-gray-600 p-3">No item in the cart.</h2>
            </div>
        </div>
        <br><br><br>
        <br><br><br>
