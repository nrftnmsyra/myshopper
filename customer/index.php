...
?>
<div class="ml-40 max-w-screen-xl pt-5 px-4 py-3 mx-auto flex flex-wrap gap-4 justify-start" id="filteredContent">
    <?php
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            ?>
            <div
                class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m">
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-900 dark:text-white">RM
                            <?php echo number_format($ps_fee, 2); ?><span class="text-sm text-gray-500"> (service fee)</span>
                        </span>
                        <button
