...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $rq_img = $row['rq_img'];
?>
        <div class="flex max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-2">
            <div class="flex-1">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><?php echo $rq_pd_name; ?></h5>
                <p class="font-normal text-gray-700 dark:text-gray-400"><?php echo $rq_desc; ?></p>
