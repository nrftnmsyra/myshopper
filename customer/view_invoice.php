...
<nav class="flex mb-1" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <div class="flex items-center">
                ...
                <a href="order_details.php?order_code=<?php echo $order_code;?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue">
                    Order Details
                </a>
            </div>
            </li>
...
<button onclick="printDiv('contentToPrint')" class="bg-blue-500 text-white px-4 py-2 rounded-md flex items-center mt-5">
            ...
            <table class="w-full text-left mb-8">
                ...
                <tbody>
                 <?php
                    ...
                    ?>
                    <tr>
                        <td class="py-4 text-gray-700"><?php echo $row2['pd_name']; ?></td>
                        <td class="py-4 text-gray-700"><?php echo $row2['order_pd_qty']; ?></td>
                        <td class="py-4 text-gray-700">RM<?php echo number_format($row2['order_total_price'],2); ?></td>
                        <td class="py-4 text-gray-700">RM<?php echo number_format($total = $row2['order_total_price']*$row2['order_pd_qty'],2); ?></td>
                    </tr>
<?php
