...
?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="#" id="openModal_<?php echo $rq_id; ?>"><img class="w-10 h-10 rounded-full" src="<?php echo $rq_img; ?>" alt="Jese image"></a>
                            <div class="ps-3">
                                <div class="text-base font-semibold"><?php echo $rq_pd_name; ?></div>
                                <div class="font-normal text-gray-500"><?php echo $rq_desc; ?></div>
                            </div>  
                        </th>
                        <?php
                        ...
                        ?>
                        <td class="px-6 py-4">
                            <select id="underline_select" class="block py-2.5 px-0 max-w-6/12 text-sm text-gray-500 bg-transparent border-0 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                <option value="waiting" selected><div class="h-2.5 w-2.5 rounded-full bg-yellow-500 me-2"></div> waiting</option>
                                <option value="accepted"><div class="h-2.5 w-2.5 rounded-full bg-green-500 me-2"></div>  accepted</option>
                                <option value="rejected"><div class="h-2.5 w-2.5 rounded-full bg-red-500 me-2"></div> rejected</option>
                            </select>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <select id="underline_select" class="block py-2.5 px-0 max-w-6/12 text-sm text-gray-500 bg-transparent border-0 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                <option value="accepted" selected><div class="h-2.5 w-2.5 rounded-full bg-green-500 me-2"> accepted</option>
                                <option value="rejected"><div class="h-2.5 w-2.5 rounded-full bg-red-500 me-2"></div> rejected</option>
                            </select>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <select id="underline_select" class="block py-2.5 px-0 max-w-6/12 text-sm text-gray-500 bg-transparent border-0 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                <option value="accepted"><div class="h-2.5 w-2.5 rounded-full bg-green-500 me-2"> accepted</option>
                                <option value="rejected"selected><div class="h-2.5 w-2.5 rounded-full bg-red-500 me-2"></div> rejected</option>
                            </select>
                        </td>
                        <td class="px-6 py-4">
                            <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Action</a>
