...
function sendMail($email, $subject, $message)
{
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($resultEmail->num_rows > 0) {
            ...
            $customerEmail = $rowEmail['order_ct_email'];
            ...
            */
             ...
             */
            $message = 'Dear ' . $name . ',<br><br>Your order with tracking number ' . $tracking_no . ' has been shipped and will be delivered in 3 days.<br><br>Thank you for shopping with us!';
            $mail->Body = $message;
